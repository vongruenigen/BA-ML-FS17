...
class Seq2Seq(Base):
    ...
    def __init_cells(self):
        ...
        if self.cfg.get('num_encoder_layers') > 1:
            self.encoder_cell = rnn.MultiRNNCell(self.encoder_cell * self.cfg.get('num_encoder_layers'))

        if self.cfg.get('num_decoder_layers') > 1:
            self.decoder_cell = rnn.MultiRNNCell(self.decoder_cell * self.cfg.get('num_decoder_layers'))
    ...
    def __init_unidirectional_encoder(self):
        ...
        with tf.variable_scope('encoder_unidirectional') as scope:
    ...
    def __get_vocab_size(self):
        ...
        return len(self.cfg.get('vocabulary_m'))
