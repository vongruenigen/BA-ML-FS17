...
Wir möchten nun noch einige ausgesuchte Beispiele Präsentieren, die gewissen Fähigkeiten der Modelle veranschaulichen. Gleichzeitig möchten wir unsere responses mit denjenigen von Cleverbot vergleichen. Kurz erklären unterschiede zu Cleverbot.
...
\begin{table}[H]
	...
	\begin{adjustbox}{max width=\textwidth}
		\begin{tabular}{ll}
			...
			\midrule
			Input: 	& \texttt{i invited her to a ppublic reading of my work , but she never came .}\\
			\midrule
		...
		\end{tabular}
	\end{adjustbox}
	\caption{Example dialogs with the OpenSubtitle model with one response per snapshot and the Cleverbot results. Resultate ändern sich bei Cleverbot mit der Zeit. Wurde gemacht am 01.06.2017 12:00}
	\label{results:example_output:OpenSubtitle_compared}
\end{table}
...
\begin{table}[H]
	...
	\begin{adjustbox}{max width=\textwidth}
		\begin{tabular}{ll}
			...
			Cleverbot:	& \texttt{You don't have any.}\\
			\midrule
			Input: 	& \texttt{Is 5 greater then 3?}\\
			\midrule
			0.5M: 	& \texttt{i don t know}\\
			1.0M: 	& \texttt{i don t know}\\
			1.5M:	& \texttt{i don t know}\\
		...
		\end{tabular}
	\end{adjustbox}
	\caption{Example dialogs with the Reddit model with one response per snapshot and the Cleverbot results. Resultate ändern sich bei Cleverbot mit der Zeit. Wurde gemacht am 01.06.2017 12:00}
	\label{results:example_output:Reddit_compared}
\end{table}
