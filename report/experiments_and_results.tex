...
\section{Beam-search}
In den bisherigen Beispielen gabt es immer wieder sehr schlechte replies. Wir möchten mit beam search \ref{fundamentals:decoding_approach} mit einer beam-width von 200 testen, ob unser Modell subjektiv bessere Antworten hätte, diese aber nicht
